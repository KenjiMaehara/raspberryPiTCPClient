...
class MyApp(App):
	...
	def build(self):
		...
		no5Button = Button(text="5",font_size = "48sp")
		no4Button = Button(text="4",font_size = "48sp")
		no3Button = Button(text="3",font_size = "48sp")
		no2Button = Button(text="2",font_size = "48sp")
		no1Button = Button(text="1",font_size = "48sp")
		noAstaButton = Button(text="*",font_size = "48sp")
		no0Button = Button(text="0",font_size = "48sp")
		noSharpButton = Button(text="#",font_size = "48sp")
