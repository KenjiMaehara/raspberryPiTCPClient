...
class MyApp(App):
	...
	def build(self):
		# Set up the layout:
		layout = GridLayout(cols=3, spacing=15, padding=30, row_default_height=15)
		...
		no9Button = Button(text="9",font_size = "48sp", font_name = 'MTLmr3m.ttf')
		no8Button = Button(text="8",font_size = "48sp", font_name = 'MTLmr3m.ttf')
		no7Button = Button(text="7",font_size = "48sp", font_name = 'MTLmr3m.ttf')
		no6Button = Button(text="6",font_size = "48sp", font_name = 'MTLmr3m.ttf')
		no5Button = Button(text="5",font_size = "48sp", font_name = 'MTLmr3m.ttf')
		no4Button = Button(text="4",font_size = "48sp", font_name = 'MTLmr3m.ttf')
		no3Button = Button(text="3",font_size = "48sp", font_name = 'MTLmr3m.ttf')
		no2Button = Button(text="2",font_size = "48sp", font_name = 'MTLmr3m.ttf')
