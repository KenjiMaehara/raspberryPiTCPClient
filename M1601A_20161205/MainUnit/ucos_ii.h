...
typedef struct os_mutex_data {
    OS_PRIO OSEventTbl[OS_EVENT_TBL_SIZE];  /* List of tasks waiting for event to occur                */
    OS_PRIO OSEventGrp;                     /* Group corresponding to tasks waiting for event to occur */
    INT8U	OSValue;                        /* Mutex value (OS_FALSE = used, OS_TRUE = available)      */
...
OS_EXT  INT8U            OSIdleCtrRun;             /* Val. reached by idle ctr at run time in 1 sec.  */
...
OS_EXT  INT8U				 OSRunning;                       /* Flag indicating that kernel is running   */
...
OS_EXT  INT8U			 OSSafetyCriticalStartFlag;
#endif
